<template>
  <div class="user-box">
    <div class="search-box">
      ...
      <div class="search-item search-item-font">支出项目:<t-input class="ipt-slt" clearable v-model="searchData.name" auto-width /></div>
      <div class="search-item search-item-font">支出金额：<t-input class="ipt-slt" clearable v-model="searchData.name" auto-width /></div>
      <div class="search-item search-item-font">支出工单：<t-input class="ipt-slt" clearable v-model="searchData.name" auto-width /></div>
    ...
    <div class="tab-box">
      <t-table row-key="index" :max-height="fixedTopRows ? 1400 : 370" :data="data" :columns="(columns as PrimaryTableCol<TableRowData>[])" size="medium" hover :bordered="false" table-layout="fixed"> </t-table>
...
export default {
  ...
  setup() {
    ...
    const setArrt = reactive({
      ...
      columns: [
        { colKey: 'id', title: '支出编号', align: 'center' },
        { colKey: 'name', title: '支出工单', align: 'center' },
        { colKey: 'phone', title: '支出类型', align: 'center' },
        { colKey: 'unit', title: '支出项目', align: 'center' },

...
let pdfDisplay = ref<string>('');
estimateNum.value = route.query.estimateNum as string;
archivesNo.value = route.query.archivesNo as string;
type.value = route.query.type as string;
pdfDisplay.value = route.query.pdfDisplay as string;
pdfUrl.value= route.query.pdfUrl as string;
viewUrl.value = import.meta.env.VITE_BASE_IFRAME_URL + '/EvaluationDepression?' + 'estimateNum=' + estimateNum.value + '&archivesNo=' + archivesNo.value + '&type=' + type.value + '&pdfDisplay=' + pdfDisplay.value + '&pdfUrl=' + pdfUrl.value;
